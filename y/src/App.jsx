...
const translations = {
  ar: {
    ...
    welcomeText:
      "إدارة العملاء والأجهزة والدراعات والفواتير والاستلام والتسليم من مكان واحد.",
  ...
  en: {
    ...
    welcomeText:
      "Manage customers, devices, controllers, invoices, check-ins and deliveries from one place.",
      ...
      return (
        <Settings
          ...
          setSettings={(newSettings) => {
            ...
            if (
              newSettings.shopName !== undefined
            ) {
              setShopName(
                newSettings.shopName
              );
            }
          }}
        />
